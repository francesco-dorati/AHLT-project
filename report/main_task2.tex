...
\bottomrule
\end{tabular}
\caption{DDI-2013 corpus statistics. The \texttt{int} class is extremely rare (40--201 pairs) and \texttt{null} dominates every split, which is the central modelling challenge of the task. Contrast Task~1, where the rare class (\textit{drug\_n}) was still $\sim$5\,\% of entities; here \texttt{int} is $<$1\,\% of pairs.}
\label{tab:dataset}
\end{table}
...
\begin{figure}[H]
\centering\includegraphics[width=0.78\linewidth]{fig21_mem_vs_svm.pdf}
...
mod6 & lemma bigrams in the words-in-between region & 64.6 & +0.3$^\dagger$ \\
...
\begin{figure}[H]
\centering\includegraphics[width=0.92\linewidth]{fig21_feature_mods.pdf}
...
\begin{figure}[H]
\centering\includegraphics[width=0.74\linewidth]{fig21_threshold_sweep.pdf}
...
\begin{itemize}
    ...
    devel M = 65.9, \textbf{test M = 66.8} --- a +2.5\,pp devel and
    +0.9\,pp test gain over single-stage \texttt{mod\_best2}, the
    largest single jump in the whole campaign.
...
\centering\includegraphics[width=\linewidth]{fig21_per_class_test.pdf}
\caption{Champion per-class P/R/F1 on test.}
\end{subfigure}\hfill
\begin{subfigure}[t]{0.46\textwidth}
\centering\includegraphics[width=\linewidth]{fig21_confmat.pdf}
...
\begin{figure}[H]
\centering\includegraphics[width=\linewidth]{fig21_strata.pdf}
...
reference reaches devel M-F1 = 55.8 (val-acc 88.35\,\%), fully
\textbf{10\,pp below the ML reference}. That gap is the opportunity, and
it already tells us where to look: \emph{representation}, not depth.
...
\bottomrule
\end{tabular}
\caption{Shipped-network per-class on devel. It trails 2.1-ML by $-$10\,pp on M-F1, with the gap concentrated in \texttt{int} (40.5 vs 69.2) and \texttt{mechanism} (50.5 vs 60.0) --- the two classes that most need syntactic context.}
\label{tab:nnref}
\end{table}
...
\begin{figure}[H]
\centering\includegraphics[width=0.95\linewidth]{fig22_input_mods.pdf}
...
\centering
\begin{subfigure}[t]{0.52\textwidth}
\centering\includegraphics[width=\linewidth]{fig22_arch.pdf}
\caption{Architecture variants (Phase~A).}
\end{subfigure}\hfill
\begin{subfigure}[t]{0.46\textwidth}
\centering\includegraphics[width=\linewidth]{fig22_hp.pdf}
...
\begin{figure}[H]
\centering\includegraphics[width=\linewidth]{fig22_relpos_strata.pdf}
...
\centering\includegraphics[width=\linewidth]{fig22_seed_audit.pdf}
\caption{Seed audit: devel vs.\ test across seeds.}
\end{subfigure}\hfill
\begin{subfigure}[t]{0.36\textwidth}
\centering\includegraphics[width=\linewidth]{fig22_devel_test_gap.pdf}
...
\begin{figure}[H]
\centering\includegraphics[width=0.6\linewidth]{fig22_per_class_test.pdf}
...
\centering
\begin{subfigure}[t]{0.52\textwidth}
\centering\includegraphics[width=\linewidth]{fig23_fs_sweep.pdf}
\caption{Few-shot $k$-sweep (Llama, \texttt{prompts01}).}
\end{subfigure}\hfill
\begin{subfigure}[t]{0.46\textwidth}
\centering\includegraphics[width=\linewidth]{fig23_fs_vs_ft.pdf}
...
is the \emph{first} divergence from Task~1, where few-shot already
reached the high-40s. The relational, imbalanced nature of DDI is much
...
\begin{figure}[H]
\centering\includegraphics[width=0.95\linewidth]{fig23_ft_configs.pdf}
...
\begin{figure}[H]
\centering\includegraphics[width=\linewidth]{fig23_prompt_crossmodel.pdf}
...
\centering\includegraphics[width=\linewidth]{fig23_confmat.pdf}
\caption{Champion confusion matrix (test).}
\end{subfigure}\hfill
\begin{subfigure}[t]{0.50\textwidth}
\centering\includegraphics[width=\linewidth]{fig23_epoch_ablation.pdf}
...
\centering
\begin{subfigure}[t]{0.50\textwidth}
\centering\includegraphics[width=\linewidth]{fig23_length_filter.pdf}
\caption{Length-filter post-processing (negative).}
\end{subfigure}\hfill
\begin{subfigure}[t]{0.48\textwidth}
\centering\includegraphics[width=\linewidth]{fig23_strata.pdf}
...
\begin{figure}[H]
\centering\includegraphics[width=\linewidth]{fig2_cross_system.pdf}
...
\centering
\begin{subfigure}[t]{0.62\textwidth}
\centering\includegraphics[width=\linewidth]{fig2_cross_perclass.pdf}
\caption{Per-class test F1 across systems.}
\end{subfigure}\hfill
\begin{subfigure}[t]{0.36\textwidth}
\centering\includegraphics[width=\linewidth]{fig2_cross_devtest.pdf}
